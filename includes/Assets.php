...
class Assets
{
    ...
    {
        $assets_url = \WPUserStatistics\Main::$BASEURL.'/public';
        $plugin_dir = \WPUserStatistics\Main::$PLUGINDIR.'/public';
    ...
    public function mix($path, $manifestDirectory = '')
    {
        ...
        if (empty($manifestDirectory)) {
            $manifestDirectory = \WPUserStatistics\Main::$PLUGINDIR.'/public';
        }
